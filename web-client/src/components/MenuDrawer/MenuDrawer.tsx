...
import { CreateOfferLocation, CreateRequestLocation } from 'src/modules/create/constants';
import {
...
const menuItems: Array<MenuItem> = [
  ...
  },
  {
    ...
    children: [
      ...
      {
        id: '4.2',
        title: 'Create Offers (under construction)',
  ...
  {
    id: '5',
    title: 'Log In (under construction)',
